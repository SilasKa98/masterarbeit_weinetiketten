...
input_file = "data/german_extracted_words_750k.txt"
...
model_preparation.create_ml_model(512, 12, 256, all_existing_chars, encoder_input_data, decoder_input_data, decoder_target_data)
