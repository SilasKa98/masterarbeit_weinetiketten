...
class ModelPreparation:
    ...
    def create_ml_model(batch_size,epochs,latent_dim, all_existing_chars, encoder_input_data, decoder_input_data, decoder_target_data):
        ...
        model.save('savedModels/256Dim_512Batch_adam_german_specialChars.h5')
        model.save('savedModels/256Dim_512Batch_adam_german_specialChars.keras')
        ...
        encoder_model.save('savedModels/encoder_256Dim_512Batch_adam_german_specialChars.h5')
        decoder_model.save('savedModels/decoder_256Dim_512Batch_adam_german_specialChars.h5')
