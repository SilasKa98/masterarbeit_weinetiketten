...
class MachineLearningService:
    ...
    def __init__(self, data_file, model_name):
        ...
        self.input_file = os.path.join(self.current_path, f'C:/Masterarbeit_ocr_env/Models/word_spelling_correction/data/{data_file}.csv')
        self.model_to_use = os.path.join(self.current_path, f'C:/Masterarbeit_ocr_env/Models/word_spelling_correction/savedModels/{model_name}.h5')
